...
class _FriendsListScreenState extends State<FriendsListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<FriendController>().loadFriends(),
    );
  }
      ...
      child: Row(
        children: [
          ...
          IconButton(
            ...
            tooltip: 'Accept',
            onPressed: () => context.read<FriendController>().acceptRequest(request.friendshipId),
          ),
          IconButton(
            icon: Icon(Icons.cancel_outlined, color: colors.error),
            tooltip: 'Decline',
            onPressed: () => context.read<FriendController>().declineRequest(request.friendshipId),
          ),
        ],
      ),
    );
